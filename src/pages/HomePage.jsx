...
import { Flag, Map, Building2, Languages, Smile, Clock, Users, Coins, MapPin, Grid3X3, Lightbulb, Moon, Sun, Trophy, Globe, BarChart3 } from 'lucide-react';
const HomePage = () => {
  const {
    theme,
    toggleTheme
  ...
  const quizTypes = [{
    ...
    title: "Emoji Countries",
    description: "Decode emoji clues to find countries",
    icon: Smile,
    path: "/quiz/emoji",
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      delay: 0.1
        ...
        <div className="flex justify-center">
           <img class="w-64 h-48 object-cover rounded-2xl shadow-2xl" alt="World map with quiz elements" src="https://images.unsplash.com/photo-1693491276200-fcd36509a2d2" />
        </div>
      </motion.section>
